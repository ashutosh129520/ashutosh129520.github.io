...
inviting you and your family to elder sister's wedding to be held on **19th November at [Ashirwad Garden](https://goo.gl/maps/5z5xX2hTYzU8VGEJ9), Ghaziabad from 4:00 PM** onwards.
...
// Nov 29, 2020
const weddingDate = new Date(2023, 11, 19);

// Wedding venue: https://goo.gl/maps/5z5xX2hTYzU8VGEJ9
const weddingVenue = new Location('Ashirwad Garden, Ghaziabad');
...
var countDownDate = new Date("Nov 19, 2023 00:00:00").getTime();
```
